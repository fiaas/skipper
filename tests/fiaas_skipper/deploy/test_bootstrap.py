...
class TestBarePodBootstrapper():
    ...
    @pytest.mark.parametrize(
        "namespace,resourcequota_spec,resources,spec_config,rbac,sa_per_app,networkingv1_ingress", [
            ...
            ("default", None, OVERRIDE_ALL_RESOURCES,
                spec_config(resources=OVERRIDE_ALL_RESOURCES), False, False, False),
            ("other-namespace", None, OVERRIDE_ALL_RESOURCES,
                spec_config(resources=OVERRIDE_ALL_RESOURCES), False, False, False),
            ("other-namespace", None, spec_config()['resources'], spec_config(), False, False, False),
