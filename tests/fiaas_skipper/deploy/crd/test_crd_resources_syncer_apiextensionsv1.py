...
from fiaas_skipper.deploy.crd.crd_resources_syncer_apiextensionsv1 import CrdResourcesSyncerApiextensionsV1
...
class TestCrdResourcesSyncerV1(object):
    ...
    def test_updates_crd_resources_when_found(self, put, get):
        ...
        crd_api_uri = "/apis/apiextensions.k8s.io/v1/customresourcedefinitions"
        calls = [
